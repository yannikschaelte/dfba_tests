import sys
from ex1_sampling_bonna import run_sampling
import os
...
dir_hdf5_folder_arg = sys.argv[1]
...
def run_dfba_sampling(dir_hdf5_folder_str, n_samples_str, which_sampler_str,
    ...
    dir_hdf5_file = os.path.join(".", "results", dir_hdf5_folder_str,
                                 "results_" + str(nstarts) + "starts_" +
                                 opt_method + '_.hdf5')
    model_dir = "../dynamic-fba/sbml-models/iJR904.xml.gz"
    data_dir = "./data/simulated_data_sigma_0_01_25starts_L-BFGS-B.csv"
