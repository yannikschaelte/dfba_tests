...
declare -x dir_results_folder="SLSQP_200"
...
sbatch /home/edudkin/dfba/dfba_tests/script_sbatched_sampling.sh $dir_results_folder $nsamples $which_samplers $nchains_l
