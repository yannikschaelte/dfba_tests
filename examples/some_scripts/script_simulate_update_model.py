...
par_dict = {"K_g": p1[0],"v_gmax": p1[1],"K_z": p1[2], "v_zmax": p1[3], "sigma_Xylose":0.04}
# title = 'original parameters before \n' + str(par_dict)
title = 'fval = ' + str(0.015692270)
save_name = '01_orig_params_before'
test_simulate(par_dict, title, save_name)
...
# #####################################################################
# # ---------------------------------------------------------------------
# get obj function value for specific parameter set
...
dir_results = "/home/erika/Documents/Projects/DFBA/results_example1/bonna/" \
         "more_noise_0_25/SLSQP_200/"
res_name = "results_200starts_SLSQP_.hdf5"
hdf5_reader = \
    read_from_hdf5.OptimizationResultHDF5Reader(dir_results + res_name)
